#First step: created R rds files from active and legacy directories and also create merged rds file

#clear the environment
rm(list=ls())


legacy_dir <- "~/GDAN//fpkm-uq/TCGA-LUSC/legacy/data/" 
active_dir <- "~/GDAN//fpkm-uq/TCGA-LUSC/active/data/"
